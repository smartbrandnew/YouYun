...
import uyun.bat.syndatabase.service.impl.ResTemplateServiceImpl;

public class ResTemplateServiceImplTest {
	
	private static ResTemplateServiceImpl resTemplateService = (ResTemplateServiceImpl)Startup.getInstance().getBean("resTemplateService");
	
	@Test
	public void testGetAllResId(){
		resTemplateService.getAllResId();
	}
	...
	public void testUpdateResId(){
		...
		resTemplateService.updateResId(resId);
	}
}

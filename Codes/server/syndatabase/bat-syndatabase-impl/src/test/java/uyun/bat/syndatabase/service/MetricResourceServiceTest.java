...
import uyun.bat.syndatabase.service.impl.MetricResourceServiceImpl;

public class MetricResourceServiceTest {
	
	private static MetricResourceServiceImpl metricResourceService = (MetricResourceServiceImpl)Startup.getInstance().getBean("metricResourceService");
	
	@Test
	public void testGetAllResId(){
		metricResourceService.getAllResId();
	}
	...
	public void testUpdateResId(){
		...
		metricResourceService.updateResId(resId);
	}
}

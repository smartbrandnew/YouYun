...
public class HTTPClientUtils {
	...
	public static String post(String url, Map<String, String> headers,
			String body, String mimeType, String charset, Integer connTimeout,
		...
		try {
			...
			if (code == 204 || code == 200) {
				...
				logger.warn("http post request failed, state code:{}, response:{}", code, result);
			}
		} finally {
	...
	public static void main(String[] args) {
		try {
			...
			// 192.168.1.109:8101
			String string = post("http://192.168.1.109:8101/trade/test.jsp",
					header, null, null, "utf-8", 10000, 10000);

...
sh -c "sed -i 's@JAVA_OPTS=.*@JAVA_OPTS=$JAVA_OPTS@' bat-dashboard.sh"

\cp -f $CURRENT_DIR/monitor-dashboard.service /usr/lib/systemd/system
systemctl enable monitor-dashboard.service

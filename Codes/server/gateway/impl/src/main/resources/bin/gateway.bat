...
set APP_HOME=%~dp0..
set PRD_HOME=%~dp0..\..
set APP_NAME=bat-gateway

set RUN_OPTS=-Dapp.name=%APP_NAME%
set RUN_OPTS=%RUN_OPTS% -Xmx1024m -XX:MaxMetaspaceSize=128m -XX:+UseStringDeduplication -XX:+HeapDumpOnOutOfMemoryError
...
rem java main class
set JAVA_MAINCLASS=uyun.bat.gateway.impl.Startup

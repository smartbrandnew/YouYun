...
class OpenStackCheck(AgentCheck):
    ...
    def get_stats_single_imges(self):
        ...
        for imges_id in image_ids:
            ...
            try:
                ...
                # print(images_details.get('visibility'))
                # print(type(images_details.get('visibility')))

                if images_details.get('visibility') in visibility_list:

                    glance_data[images_details.get('visibility')][0] += 1
                    glance_data[images_details.get('visibility')][1] += round(images_details.get('size')/1024.0/1024.0,2)
    ...
    def get_cinder_stats(self):
        ...
        try :
            ...
            for volume in volumes.get('volumes',''):
                # print('volume size',volume.get('size',0))
    ...
    def get_snapshots_stats(self):
        ...
        try :
            ...
            for snapshot in snapshots.get('snapshots'):
                # print('snapshot size',snapshot.get('size',0))
   ...
   ### get openstack Nova Cinder Neutron Keystone Nstatus

...
class ConsulCheck(AgentCheck):
    ...
    def _check_for_leader_change(self, instance):
        ...
        if not leader:
            ...
            #   3. The Monitor Agent is not able to reach the Consul instance (network partition et al.)
        ...
        if perform_catalog_checks:
            ...
            for service in services:
                ...
                for node in nodes_with_service:
                    ...
                    # If there is no Check for the node then Consul and monitor-agent consider it up

...
class Disk(AgentCheck):
    ...
    def _load_conf(self, instance):
        ...
        # FIXME: 6.x, drop use_mount option in datamonitor.conf
        self._load_legacy_option(instance, 'use_mount', False,
                                 operation=_is_affirmative)
        # FIXME: 6.x, drop device_blacklist_re option in datamonitor.conf
    ...
    def _collect_part_metrics(self, part, usage):
        ...
        # FIXME: 6.x, use percent, a lot more logical than pct_usage
    ...
    def _collect_metrics_manually(self, device):
        ...
        # Rather than grabbing pct_usage, let's calculate it to be more precise

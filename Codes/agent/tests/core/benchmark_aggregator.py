# -*- coding: utf-8 -*-
"""
Performance tests for the agent/monitorstatsd metrics aggregator.
"""
...
class TestAggregatorPerf(object):
    ...
    def test_monitorstatsd_aggregation_perf(self):
    ...
    def test_monitorstatsd_utf8_events(self):
        ma = MetricsBucketAggregator('my.host')
    ...
    def test_monitorstatsd_ascii_events(self):
        ma = MetricsBucketAggregator('my.host')
...
if __name__ == '__main__':
    ...
    #t.test_monitorstatsd_aggregation_perf()
    #t.test_checksd_aggregation_perf()
    t.test_monitorstatsd_utf8_events()

...
class TestUtilsLogger(unittest.TestCase):
    ...
    def test_api_key_log_obfuscation(self):
        ...
        def log_api_key():
            ...
            mtype = "metrics"
            endpoint = "m_url"
            url = "https://x-x-x-app.agent.datamonitor.com/intake/?api_key=foobar"
        ...
        result = handler.pop()
        expected_result = u"Sending metrics to endpoint m_url at "\
            "https://x-x-x-app.agent.datamonitor.com/intake/?api_key=*************************oobar"

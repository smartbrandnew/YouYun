...
CREATE LOGIN datamonitor WITH PASSWORD = '340$Uuxwp7Mcxo7Khy';
CREATE USER datamonitor FOR LOGIN datamonitor;
GRANT SELECT on sys.dm_os_performance_counters to datamonitor;
GRANT VIEW SERVER STATE to datamonitor;
"""

    ...
    task install: ['ci:common:install'] do
      ...
      unless Dir.exist? File.expand_path(phpfpm_rootdir)
        sh %(curl -s -L\
             ...
             https://s3.amazonaws.com/monitor-agent-tarball-mirror/nginx-#{nginx_version}.tar.gz)
        ...
        sh %(curl -s -L\
             ...
             https://s3.amazonaws.com/monitor-agent-tarball-mirror/php-#{php_version}.tar.bz2)

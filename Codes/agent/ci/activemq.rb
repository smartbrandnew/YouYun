  ...
  namespace :activemq do |flavor|
    ...
    task install: ['ci:common:install'] do
      unless Dir.exist? File.expand_path(activemq_rootdir)
        ...
        sh %(curl -s -L\
             ...
             https://s3.amazonaws.com/monitor-agent-tarball-mirror/apache-activemq-#{activemq_version}-bin.tar.gz)
    ...
    task before_script: ['ci:common:before_script'] do
      ...
      sh %(curl -s -L\
           ...
           https://s3.amazonaws.com/monitor-agent-tarball-mirror/apache-activemq-kahadb.tar.gz)

...
* [OTHER] Upgrade `pymongo` dependency from `2.6.3` to `2.8` on Windows Monitor Agent 32-bit MSI Installer.
...
* [FEATURE] Add more metrics to MongoDB check for newer versions of MongoDB [#735](https://github.com/Datamonitor/monitor-agent/issues/735)
...
* [BUGFIX] MySQL InnoDB metrics are now only collected with InnoDB is enabled ([#566](https://github.com/Datamonitor/monitor-agent/issues/566))
...
* [FEATURE] Allow strings to be elements in monitorstatsd sets ([#300](https://github.com/Datamonitor/monitor-agent/issues/326))
...
# 3.1.3
#### Details
https://github.com/Datamonitor/monitor-agent/compare/3.1.2...3.1.3
...
# 3.1.2
#### Details
https://github.com/Datamonitor/monitor-agent/compare/3.1.1...3.1.2

#### Changes
* [FEATURE] monitorstream (parsing logs with monitor-agent) supports parsing classes in addition to parsing functions.

# 3.1.1
#### Details
https://github.com/Datamonitor/monitor-agent/compare/3.1.0...3.1.1

#### Changes
* [FEATURE] Multi-instance JMX check
* [FEATURE] monitorstatsd counters now send 0 for up to 10 minutes after the last increment(). They work with alerts.
* [BUGFIX] [part 1 of [#16][]5](https://github.com/Datamonitor/monitor-agent/issues/165) monitorstatsd's average is fixed
* [BUGFIX] HAProxy logging level was logging debug messages by default.

# 3.1.0
#### Details
https://github.com/Datamonitor/monitor-agent/compare/3.0.5...3.1.0
...
* [BUGFIX] [#150](https://github.com/Datamonitor/monitor-agent/issues/150) - Fix Pexpect dependency
...
* [changeset](https://github.com/Datamonitor/monitor-agent/compare/3.0.5...3.1.0)

# 3.0.5
#### Details
https://github.com/Datamonitor/monitor-agent/compare/3.0.4...3.0.5

#### Changes
* [BUGFIX] Incorrect version dependencies between `datamonitor-agent` and `datamonitor-agent-base`.
* [BUGFIX] [#130](https://github.com/Datamonitor/monitor-agent/issues/130) Fixes a crash when changing the listening port of the forwarder.

### How to upgrade from 3.0.4 on Debian and Ubuntu

When we released datamonitor-agent 3.0.4 we made a mistake and messed up the version dependency between packages. As a result, whenever you run `apt-get upgrade` or `apt-get dist-upgrade` and 3.0.4 is installed you may get the following error:

`E: Couldn't configure pre-depend datamonitor-agent-base for datamonitor-agent, probably a dependency cycle.`

If that's the case, don't panic: there is a simple fix. Simply run:

    sudo apt-get update
    sudo apt-get remove datamonitor-agent
    sudo apt-get install datamonitor-agent

to get the new versions up-and-running.

# 3.0.4
#### Details
https://github.com/Datamonitor/monitor-agent/compare/3.0.3...3.0.4

#### Changes
* [FEATURE] [#112](https://github.com/Datamonitor/monitor-agent/issues/112) Thanks to [@charles-dyfis-net](https://github.com/charles-dyfis-net), the agent supports extra `emitters`. An emitter is an output for events and metrics.
* [FEATURE] [#117](https://github.com/Datamonitor/monitor-agent/issues/117) Thanks to [@rl-0x0](https://github.com/rl-0x0), the agent can now parse supervisord logs and turn them into events and metrics.
* [FEATURE] [#121](https://github.com/Datamonitor/monitor-agent/issues/121) Thanks to [@charles-dyfis-net](https://github.com/charles-dyfis-net), the agent supports custom checks. Check out our README for more details.

# 3.0.3
#### Details
https://github.com/Datamonitor/monitor-agent/compare/3.0.2...3.0.3

#### Changes
* [BUGFIX] [#82](https://github.com/Datamonitor/monitor-agent/issues/82) Now proudly runs on Amazon Web Services Linux.
* [FEATURE] [#110](https://github.com/Datamonitor/monitor-agent/issues/110) More ElasticSearch metrics

# 3.0.2
#### Details
https://github.com/Datamonitor/monitor-agent/compare/3.0.1...3.0.2

#### Changes
* [BUGFIX] [#105](https://github.com/Datamonitor/monitor-agent/issues/105) Fix for ElasticSearch 0.18

# 3.0.1
#### Changes
* [BUGFIX] Support for ElasticSearch 0.18
* [BUGFIX] [#95](https://github.com/Datamonitor/monitor-agent/issues/95) Fix for incorrect supervisord configuration on debian. More details [here](https://github.com/Datamonitor/monitor-agent/wiki/How-to-fix-supervisor) to test whether you are affected.

# 3.0.0
* **This is a major version**

#### Changes
* [FEATURE] [monitorstatsd](http://api.datamonitorhq.com/guides/monitorstatsd), a drop-in replacement of statsd with tagging magic, bundled with the agent. Compatible with all statsd clients.
* [FEATURE] [#21](https://github.com/Datamonitor/monitor-agent/issues/21) Support for ElasticSearch 0.19

# 2.2.28
#### Changes
* [FEATURE] [#83](https://github.com/Datamonitor/monitor-agent/issues/83) Support authenticated connections to redis. Simply use the following stanza in `/etc/monitor-agent/datamonitor.conf` to support multiple servers

    redis_urls: host:port, password[@host][]:port

# 2.2.27
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.26...2.2.27

#### Changes
* [BUGFIX] [#80](https://github.com/Datamonitor/monitor-agent/issues/80) Agent now runs happily in locales with different radix separator
* [FEATURE] [#73](https://github.com/Datamonitor/monitor-agent/issues/73) Allow checks to record tag metrics

# 2.2.26
#### Changes
* [BUGFIX][#76](https://github.com/Datamonitor/monitor-agent/issues/76) Fixes nagios perfdata parsing (if templates contained brackets)

# 2.2.25
#### Changes
* [BUGFIX] [#68](https://github.com/Datamonitor/monitor-agent/issues/68) Fixes off-by-one monitor parsing error
* [BUGFIX] [#65](https://github.com/Datamonitor/monitor-agent/issues/65) More robust uninstall script on Debian & Ubuntu
* [FEATURE] [#71](https://github.com/Datamonitor/monitor-agent/issues/71) Supports for network metrics on Mac OS X
* [FEATURE] [#62](https://github.com/Datamonitor/monitor-agent/issues/62) Sends instance-related EC2 metadata to Datamonitor to enable host aliases

# 2.2.24
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.22...2.2.24
...
# 2.2.20
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.19...2.2.20
...
# 2.2.19
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.18...2.2.19

#### Changes
* [BUGFIX] varnish support is now xml-based, to not break when reading bitmap values ([#42][])
* [BUGFIX] less verbose errors in monitorstream ([#55][])
...
# 2.2.17
#### Changes
* [BUGFIX] On CentOS, pid was always saved in /tmp/monitor-agent.pid ([#51][])
...
# 2.2.15
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.14...2.2.15
...
# 2.2.14
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.12...2.2.14
...
# 2.2.12
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.11...2.2.12
...
# 2.2.11
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.10...2.2.11

#### Changes
* [BUGFIX] Prevent counters from wrapping ([#23](/Datamonitor/monitor-agent/pull/30))
* [BUGFIX] Collect shared memory metric, accessible in Datamonitor via system.mem.shared.

# 2.2.10
#### Details
https://github.com/Datamonitor/monitor-agent/compare/2.2.9...2.2.10

#### Changes
* [BUGFIX] On CentOS5, when both `datamonitor-agent` and `datamonitor-agent-base` are installed, `datamonitor-agent-base` runs with the stock 2.4 python, which allows python modules that support integrations (e.g. mysql) to be installed with yum.

# 2.2.9 (minor)
#### Details
  https://github.com/Datamonitor/monitor-agent/issues?milestone=1&state=closed
...
[#16]: https://github.com/Datamonitor/monitor-agent/issues/16
[#21]: https://github.com/Datamonitor/monitor-agent/issues/21
[#23]: https://github.com/Datamonitor/monitor-agent/issues/23
[#30]: https://github.com/Datamonitor/monitor-agent/issues/30
[#42]: https://github.com/Datamonitor/monitor-agent/issues/42
[#48]: https://github.com/Datamonitor/monitor-agent/issues/48
[#49]: https://github.com/Datamonitor/monitor-agent/issues/49
[#51]: https://github.com/Datamonitor/monitor-agent/issues/51
[#55]: https://github.com/Datamonitor/monitor-agent/issues/55
[#57]: https://github.com/Datamonitor/monitor-agent/issues/57
[#62]: https://github.com/Datamonitor/monitor-agent/issues/62
[#63]: https://github.com/Datamonitor/monitor-agent/issues/63
[#65]: https://github.com/Datamonitor/monitor-agent/issues/65
[#66]: https://github.com/Datamonitor/monitor-agent/issues/66
[#68]: https://github.com/Datamonitor/monitor-agent/issues/68
[#71]: https://github.com/Datamonitor/monitor-agent/issues/71
[#72]: https://github.com/Datamonitor/monitor-agent/issues/72
[#73]: https://github.com/Datamonitor/monitor-agent/issues/73
[#76]: https://github.com/Datamonitor/monitor-agent/issues/76
[#78]: https://github.com/Datamonitor/monitor-agent/issues/78
[#79]: https://github.com/Datamonitor/monitor-agent/issues/79
[#80]: https://github.com/Datamonitor/monitor-agent/issues/80
[#81]: https://github.com/Datamonitor/monitor-agent/issues/81
[#82]: https://github.com/Datamonitor/monitor-agent/issues/82
[#83]: https://github.com/Datamonitor/monitor-agent/issues/83
[#95]: https://github.com/Datamonitor/monitor-agent/issues/95
[#105]: https://github.com/Datamonitor/monitor-agent/issues/105
[#110]: https://github.com/Datamonitor/monitor-agent/issues/110
[#112]: https://github.com/Datamonitor/monitor-agent/issues/112
[#117]: https://github.com/Datamonitor/monitor-agent/issues/117
[#121]: https://github.com/Datamonitor/monitor-agent/issues/121
[#130]: https://github.com/Datamonitor/monitor-agent/issues/130
[#131]: https://github.com/Datamonitor/monitor-agent/issues/131
[#150]: https://github.com/Datamonitor/monitor-agent/issues/150
[#165]: https://github.com/Datamonitor/monitor-agent/issues/165
[#200]: https://github.com/Datamonitor/monitor-agent/issues/200
[#201]: https://github.com/Datamonitor/monitor-agent/issues/201
[#202]: https://github.com/Datamonitor/monitor-agent/issues/202
[#227]: https://github.com/Datamonitor/monitor-agent/issues/227
[#245]: https://github.com/Datamonitor/monitor-agent/issues/245
[#253]: https://github.com/Datamonitor/monitor-agent/issues/253
[#257]: https://github.com/Datamonitor/monitor-agent/issues/257
[#261]: https://github.com/Datamonitor/monitor-agent/issues/261
[#271]: https://github.com/Datamonitor/monitor-agent/issues/271
[#276]: https://github.com/Datamonitor/monitor-agent/issues/276
[#277]: https://github.com/Datamonitor/monitor-agent/issues/277
[#278]: https://github.com/Datamonitor/monitor-agent/issues/278
[#283]: https://github.com/Datamonitor/monitor-agent/issues/283
[#290]: https://github.com/Datamonitor/monitor-agent/issues/290
[#291]: https://github.com/Datamonitor/monitor-agent/issues/291
[#293]: https://github.com/Datamonitor/monitor-agent/issues/293
[#297]: https://github.com/Datamonitor/monitor-agent/issues/297
[#299]: https://github.com/Datamonitor/monitor-agent/issues/299
[#300]: https://github.com/Datamonitor/monitor-agent/issues/300
[#307]: https://github.com/Datamonitor/monitor-agent/issues/307
[#310]: https://github.com/Datamonitor/monitor-agent/issues/310
[#311]: https://github.com/Datamonitor/monitor-agent/issues/311
[#313]: https://github.com/Datamonitor/monitor-agent/issues/313
[#318]: https://github.com/Datamonitor/monitor-agent/issues/318
[#320]: https://github.com/Datamonitor/monitor-agent/issues/320
[#325]: https://github.com/Datamonitor/monitor-agent/issues/325
[#326]: https://github.com/Datamonitor/monitor-agent/issues/326
[#330]: https://github.com/Datamonitor/monitor-agent/issues/330
[#332]: https://github.com/Datamonitor/monitor-agent/issues/332
[#334]: https://github.com/Datamonitor/monitor-agent/issues/334
[#348]: https://github.com/Datamonitor/monitor-agent/issues/348
[#351]: https://github.com/Datamonitor/monitor-agent/issues/351
[#359]: https://github.com/Datamonitor/monitor-agent/issues/359
[#369]: https://github.com/Datamonitor/monitor-agent/issues/369
[#375]: https://github.com/Datamonitor/monitor-agent/issues/375
[#377]: https://github.com/Datamonitor/monitor-agent/issues/377
[#381]: https://github.com/Datamonitor/monitor-agent/issues/381
[#385]: https://github.com/Datamonitor/monitor-agent/issues/385
[#390]: https://github.com/Datamonitor/monitor-agent/issues/390
[#394]: https://github.com/Datamonitor/monitor-agent/issues/394
[#396]: https://github.com/Datamonitor/monitor-agent/issues/396
[#397]: https://github.com/Datamonitor/monitor-agent/issues/397
[#401]: https://github.com/Datamonitor/monitor-agent/issues/401
[#402]: https://github.com/Datamonitor/monitor-agent/issues/402
[#404]: https://github.com/Datamonitor/monitor-agent/issues/404
[#408]: https://github.com/Datamonitor/monitor-agent/issues/408
[#410]: https://github.com/Datamonitor/monitor-agent/issues/410
[#412]: https://github.com/Datamonitor/monitor-agent/issues/412
[#413]: https://github.com/Datamonitor/monitor-agent/issues/413
[#414]: https://github.com/Datamonitor/monitor-agent/issues/414
[#415]: https://github.com/Datamonitor/monitor-agent/issues/415
[#419]: https://github.com/Datamonitor/monitor-agent/issues/419
[#422]: https://github.com/Datamonitor/monitor-agent/issues/422
[#423]: https://github.com/Datamonitor/monitor-agent/issues/423
[#426]: https://github.com/Datamonitor/monitor-agent/issues/426
[#427]: https://github.com/Datamonitor/monitor-agent/issues/427
[#434]: https://github.com/Datamonitor/monitor-agent/issues/434
[#435]: https://github.com/Datamonitor/monitor-agent/issues/435
[#450]: https://github.com/Datamonitor/monitor-agent/issues/450
[#465]: https://github.com/Datamonitor/monitor-agent/issues/465
[#472]: https://github.com/Datamonitor/monitor-agent/issues/472
[#475]: https://github.com/Datamonitor/monitor-agent/issues/475
[#478]: https://github.com/Datamonitor/monitor-agent/issues/478
[#480]: https://github.com/Datamonitor/monitor-agent/issues/480
[#481]: https://github.com/Datamonitor/monitor-agent/issues/481
[#483]: https://github.com/Datamonitor/monitor-agent/issues/483
[#490]: https://github.com/Datamonitor/monitor-agent/issues/490
[#496]: https://github.com/Datamonitor/monitor-agent/issues/496
[#498]: https://github.com/Datamonitor/monitor-agent/issues/498
[#501]: https://github.com/Datamonitor/monitor-agent/issues/501
[#502]: https://github.com/Datamonitor/monitor-agent/issues/502
[#507]: https://github.com/Datamonitor/monitor-agent/issues/507
[#512]: https://github.com/Datamonitor/monitor-agent/issues/512
[#515]: https://github.com/Datamonitor/monitor-agent/issues/515
[#521]: https://github.com/Datamonitor/monitor-agent/issues/521
[#532]: https://github.com/Datamonitor/monitor-agent/issues/532
[#541]: https://github.com/Datamonitor/monitor-agent/issues/541
[#544]: https://github.com/Datamonitor/monitor-agent/issues/544
[#546]: https://github.com/Datamonitor/monitor-agent/issues/546
[#551]: https://github.com/Datamonitor/monitor-agent/issues/551
[#554]: https://github.com/Datamonitor/monitor-agent/issues/554
[#558]: https://github.com/Datamonitor/monitor-agent/issues/558
[#566]: https://github.com/Datamonitor/monitor-agent/issues/566
[#567]: https://github.com/Datamonitor/monitor-agent/issues/567
[#569]: https://github.com/Datamonitor/monitor-agent/issues/569
[#575]: https://github.com/Datamonitor/monitor-agent/issues/575
[#577]: https://github.com/Datamonitor/monitor-agent/issues/577
[#580]: https://github.com/Datamonitor/monitor-agent/issues/580
[#581]: https://github.com/Datamonitor/monitor-agent/issues/581
[#582]: https://github.com/Datamonitor/monitor-agent/issues/582
[#590]: https://github.com/Datamonitor/monitor-agent/issues/590
[#600]: https://github.com/Datamonitor/monitor-agent/issues/600
[#608]: https://github.com/Datamonitor/monitor-agent/issues/608
[#615]: https://github.com/Datamonitor/monitor-agent/issues/615
[#619]: https://github.com/Datamonitor/monitor-agent/issues/619
[#622]: https://github.com/Datamonitor/monitor-agent/issues/622
[#624]: https://github.com/Datamonitor/monitor-agent/issues/624
[#627]: https://github.com/Datamonitor/monitor-agent/issues/627
[#632]: https://github.com/Datamonitor/monitor-agent/issues/632
[#641]: https://github.com/Datamonitor/monitor-agent/issues/641
[#643]: https://github.com/Datamonitor/monitor-agent/issues/643
[#646]: https://github.com/Datamonitor/monitor-agent/issues/646
[#647]: https://github.com/Datamonitor/monitor-agent/issues/647
[#653]: https://github.com/Datamonitor/monitor-agent/issues/653
[#654]: https://github.com/Datamonitor/monitor-agent/issues/654
[#657]: https://github.com/Datamonitor/monitor-agent/issues/657
[#665]: https://github.com/Datamonitor/monitor-agent/issues/665
[#677]: https://github.com/Datamonitor/monitor-agent/issues/677
[#706]: https://github.com/Datamonitor/monitor-agent/issues/706
[#729]: https://github.com/Datamonitor/monitor-agent/issues/729
[#730]: https://github.com/Datamonitor/monitor-agent/issues/730
[#735]: https://github.com/Datamonitor/monitor-agent/issues/735
[#752]: https://github.com/Datamonitor/monitor-agent/issues/752
[#760]: https://github.com/Datamonitor/monitor-agent/issues/760
[#766]: https://github.com/Datamonitor/monitor-agent/issues/766
[#770]: https://github.com/Datamonitor/monitor-agent/issues/770
[#780]: https://github.com/Datamonitor/monitor-agent/issues/780
[#784]: https://github.com/Datamonitor/monitor-agent/issues/784
[#787]: https://github.com/Datamonitor/monitor-agent/issues/787
[#790]: https://github.com/Datamonitor/monitor-agent/issues/790
[#806]: https://github.com/Datamonitor/monitor-agent/issues/806
[#809]: https://github.com/Datamonitor/monitor-agent/issues/809
[#810]: https://github.com/Datamonitor/monitor-agent/issues/810
[#815]: https://github.com/Datamonitor/monitor-agent/issues/815
[#826]: https://github.com/Datamonitor/monitor-agent/issues/826
[#827]: https://github.com/Datamonitor/monitor-agent/issues/827
[#834]: https://github.com/Datamonitor/monitor-agent/issues/834
[#838]: https://github.com/Datamonitor/monitor-agent/issues/838
[#844]: https://github.com/Datamonitor/monitor-agent/issues/844
[#848]: https://github.com/Datamonitor/monitor-agent/issues/848
[#849]: https://github.com/Datamonitor/monitor-agent/issues/849
[#852]: https://github.com/Datamonitor/monitor-agent/issues/852
[#863]: https://github.com/Datamonitor/monitor-agent/issues/863
[#875]: https://github.com/Datamonitor/monitor-agent/issues/875
[#876]: https://github.com/Datamonitor/monitor-agent/issues/876
[#883]: https://github.com/Datamonitor/monitor-agent/issues/883
[#887]: https://github.com/Datamonitor/monitor-agent/issues/887
[#891]: https://github.com/Datamonitor/monitor-agent/issues/891
[#893]: https://github.com/Datamonitor/monitor-agent/issues/893
[#894]: https://github.com/Datamonitor/monitor-agent/issues/894
[#899]: https://github.com/Datamonitor/monitor-agent/issues/899
[#900]: https://github.com/Datamonitor/monitor-agent/issues/900
[#904]: https://github.com/Datamonitor/monitor-agent/issues/904
[#917]: https://github.com/Datamonitor/monitor-agent/issues/917
[#919]: https://github.com/Datamonitor/monitor-agent/issues/919
[#921]: https://github.com/Datamonitor/monitor-agent/issues/921
[#922]: https://github.com/Datamonitor/monitor-agent/issues/922
[#927]: https://github.com/Datamonitor/monitor-agent/issues/927
[#928]: https://github.com/Datamonitor/monitor-agent/issues/928
[#930]: https://github.com/Datamonitor/monitor-agent/issues/930
[#933]: https://github.com/Datamonitor/monitor-agent/issues/933
[#935]: https://github.com/Datamonitor/monitor-agent/issues/935
[#940]: https://github.com/Datamonitor/monitor-agent/issues/940
[#947]: https://github.com/Datamonitor/monitor-agent/issues/947
[#949]: https://github.com/Datamonitor/monitor-agent/issues/949
[#951]: https://github.com/Datamonitor/monitor-agent/issues/951
[#958]: https://github.com/Datamonitor/monitor-agent/issues/958
[#960]: https://github.com/Datamonitor/monitor-agent/issues/960
[#962]: https://github.com/Datamonitor/monitor-agent/issues/962
[#963]: https://github.com/Datamonitor/monitor-agent/issues/963
[#964]: https://github.com/Datamonitor/monitor-agent/issues/964
[#971]: https://github.com/Datamonitor/monitor-agent/issues/971
[#972]: https://github.com/Datamonitor/monitor-agent/issues/972
[#975]: https://github.com/Datamonitor/monitor-agent/issues/975
[#977]: https://github.com/Datamonitor/monitor-agent/issues/977
[#980]: https://github.com/Datamonitor/monitor-agent/issues/980
[#981]: https://github.com/Datamonitor/monitor-agent/issues/981
[#982]: https://github.com/Datamonitor/monitor-agent/issues/982
[#984]: https://github.com/Datamonitor/monitor-agent/issues/984
[#996]: https://github.com/Datamonitor/monitor-agent/issues/996
[#1001]: https://github.com/Datamonitor/monitor-agent/issues/1001
[#1002]: https://github.com/Datamonitor/monitor-agent/issues/1002
[#1008]: https://github.com/Datamonitor/monitor-agent/issues/1008
[#1013]: https://github.com/Datamonitor/monitor-agent/issues/1013
[#1014]: https://github.com/Datamonitor/monitor-agent/issues/1014
[#1015]: https://github.com/Datamonitor/monitor-agent/issues/1015
[#1016]: https://github.com/Datamonitor/monitor-agent/issues/1016
[#1017]: https://github.com/Datamonitor/monitor-agent/issues/1017
[#1018]: https://github.com/Datamonitor/monitor-agent/issues/1018
[#1019]: https://github.com/Datamonitor/monitor-agent/issues/1019
[#1023]: https://github.com/Datamonitor/monitor-agent/issues/1023
[#1024]: https://github.com/Datamonitor/monitor-agent/issues/1024
[#1027]: https://github.com/Datamonitor/monitor-agent/issues/1027
[#1028]: https://github.com/Datamonitor/monitor-agent/issues/1028
[#1029]: https://github.com/Datamonitor/monitor-agent/issues/1029
[#1031]: https://github.com/Datamonitor/monitor-agent/issues/1031
[#1035]: https://github.com/Datamonitor/monitor-agent/issues/1035
[#1036]: https://github.com/Datamonitor/monitor-agent/issues/1036
[#1041]: https://github.com/Datamonitor/monitor-agent/issues/1041
[#1060]: https://github.com/Datamonitor/monitor-agent/issues/1060
[#1065]: https://github.com/Datamonitor/monitor-agent/issues/1065
[#1068]: https://github.com/Datamonitor/monitor-agent/issues/1068
[#1069]: https://github.com/Datamonitor/monitor-agent/issues/1069
[#1073]: https://github.com/Datamonitor/monitor-agent/issues/1073
[#1080]: https://github.com/Datamonitor/monitor-agent/issues/1080
[#1101]: https://github.com/Datamonitor/monitor-agent/issues/1101
[#1105]: https://github.com/Datamonitor/monitor-agent/issues/1105
[#1115]: https://github.com/Datamonitor/monitor-agent/issues/1115
[#1116]: https://github.com/Datamonitor/monitor-agent/issues/1116
[#1117]: https://github.com/Datamonitor/monitor-agent/issues/1117
[#1123]: https://github.com/Datamonitor/monitor-agent/issues/1123
[#1124]: https://github.com/Datamonitor/monitor-agent/issues/1124
[#1141]: https://github.com/Datamonitor/monitor-agent/issues/1141
[#1152]: https://github.com/Datamonitor/monitor-agent/issues/1152
[#1153]: https://github.com/Datamonitor/monitor-agent/issues/1153
[#1155]: https://github.com/Datamonitor/monitor-agent/issues/1155
[#1156]: https://github.com/Datamonitor/monitor-agent/issues/1156
[#1162]: https://github.com/Datamonitor/monitor-agent/issues/1162
[#1163]: https://github.com/Datamonitor/monitor-agent/issues/1163
[#1164]: https://github.com/Datamonitor/monitor-agent/issues/1164
[#1165]: https://github.com/Datamonitor/monitor-agent/issues/1165
[#1171]: https://github.com/Datamonitor/monitor-agent/issues/1171
[#1173]: https://github.com/Datamonitor/monitor-agent/issues/1173
[#1175]: https://github.com/Datamonitor/monitor-agent/issues/1175
[#1181]: https://github.com/Datamonitor/monitor-agent/issues/1181
[#1187]: https://github.com/Datamonitor/monitor-agent/issues/1187
[#1188]: https://github.com/Datamonitor/monitor-agent/issues/1188
[#1192]: https://github.com/Datamonitor/monitor-agent/issues/1192
[#1200]: https://github.com/Datamonitor/monitor-agent/issues/1200
[#1201]: https://github.com/Datamonitor/monitor-agent/issues/1201
[#1202]: https://github.com/Datamonitor/monitor-agent/issues/1202
[#1203]: https://github.com/Datamonitor/monitor-agent/issues/1203
[#1205]: https://github.com/Datamonitor/monitor-agent/issues/1205
[#1207]: https://github.com/Datamonitor/monitor-agent/issues/1207
[#1208]: https://github.com/Datamonitor/monitor-agent/issues/1208
[#1210]: https://github.com/Datamonitor/monitor-agent/issues/1210
[#1211]: https://github.com/Datamonitor/monitor-agent/issues/1211
[#1213]: https://github.com/Datamonitor/monitor-agent/issues/1213
[#1214]: https://github.com/Datamonitor/monitor-agent/issues/1214
[#1218]: https://github.com/Datamonitor/monitor-agent/issues/1218
[#1219]: https://github.com/Datamonitor/monitor-agent/issues/1219
[#1221]: https://github.com/Datamonitor/monitor-agent/issues/1221
[#1222]: https://github.com/Datamonitor/monitor-agent/issues/1222
[#1225]: https://github.com/Datamonitor/monitor-agent/issues/1225
[#1226]: https://github.com/Datamonitor/monitor-agent/issues/1226
[#1227]: https://github.com/Datamonitor/monitor-agent/issues/1227
[#1235]: https://github.com/Datamonitor/monitor-agent/issues/1235
[#1236]: https://github.com/Datamonitor/monitor-agent/issues/1236
[#1238]: https://github.com/Datamonitor/monitor-agent/issues/1238
[#1240]: https://github.com/Datamonitor/monitor-agent/issues/1240
[#1255]: https://github.com/Datamonitor/monitor-agent/issues/1255
[#1260]: https://github.com/Datamonitor/monitor-agent/issues/1260
[#1267]: https://github.com/Datamonitor/monitor-agent/issues/1267
[#1269]: https://github.com/Datamonitor/monitor-agent/issues/1269
[#1272]: https://github.com/Datamonitor/monitor-agent/issues/1272
[#1273]: https://github.com/Datamonitor/monitor-agent/issues/1273
[#1274]: https://github.com/Datamonitor/monitor-agent/issues/1274
[#1275]: https://github.com/Datamonitor/monitor-agent/issues/1275
[#1278]: https://github.com/Datamonitor/monitor-agent/issues/1278
[#1279]: https://github.com/Datamonitor/monitor-agent/issues/1279
[#1281]: https://github.com/Datamonitor/monitor-agent/issues/1281
[#1282]: https://github.com/Datamonitor/monitor-agent/issues/1282
[#1284]: https://github.com/Datamonitor/monitor-agent/issues/1284
[#1285]: https://github.com/Datamonitor/monitor-agent/issues/1285
[#1297]: https://github.com/Datamonitor/monitor-agent/issues/1297
[#1310]: https://github.com/Datamonitor/monitor-agent/issues/1310
[#1318]: https://github.com/Datamonitor/monitor-agent/issues/1318
[#1326]: https://github.com/Datamonitor/monitor-agent/issues/1326
[#1332]: https://github.com/Datamonitor/monitor-agent/issues/1332
[#1343]: https://github.com/Datamonitor/monitor-agent/issues/1343
[#1345]: https://github.com/Datamonitor/monitor-agent/issues/1345
[#1348]: https://github.com/Datamonitor/monitor-agent/issues/1348
[#1350]: https://github.com/Datamonitor/monitor-agent/issues/1350
[#1370]: https://github.com/Datamonitor/monitor-agent/issues/1370
[#1377]: https://github.com/Datamonitor/monitor-agent/issues/1377
[#1379]: https://github.com/Datamonitor/monitor-agent/issues/1379
[#1380]: https://github.com/Datamonitor/monitor-agent/issues/1380
[#1383]: https://github.com/Datamonitor/monitor-agent/issues/1383
[#1388]: https://github.com/Datamonitor/monitor-agent/issues/1388
[#1389]: https://github.com/Datamonitor/monitor-agent/issues/1389
[#1390]: https://github.com/Datamonitor/monitor-agent/issues/1390
[#1391]: https://github.com/Datamonitor/monitor-agent/issues/1391
[#1393]: https://github.com/Datamonitor/monitor-agent/issues/1393
[#1395]: https://github.com/Datamonitor/monitor-agent/issues/1395
[#1396]: https://github.com/Datamonitor/monitor-agent/issues/1396
[#1399]: https://github.com/Datamonitor/monitor-agent/issues/1399
[#1400]: https://github.com/Datamonitor/monitor-agent/issues/1400
[#1401]: https://github.com/Datamonitor/monitor-agent/issues/1401
[#1408]: https://github.com/Datamonitor/monitor-agent/issues/1408
[#1414]: https://github.com/Datamonitor/monitor-agent/issues/1414
[#1415]: https://github.com/Datamonitor/monitor-agent/issues/1415
[#1416]: https://github.com/Datamonitor/monitor-agent/issues/1416
[#1422]: https://github.com/Datamonitor/monitor-agent/issues/1422
[#1427]: https://github.com/Datamonitor/monitor-agent/issues/1427
[#1429]: https://github.com/Datamonitor/monitor-agent/issues/1429
[#1435]: https://github.com/Datamonitor/monitor-agent/issues/1435
[#1436]: https://github.com/Datamonitor/monitor-agent/issues/1436
[#1438]: https://github.com/Datamonitor/monitor-agent/issues/1438
[#1441]: https://github.com/Datamonitor/monitor-agent/issues/1441
[#1442]: https://github.com/Datamonitor/monitor-agent/issues/1442
[#1443]: https://github.com/Datamonitor/monitor-agent/issues/1443
[#1444]: https://github.com/Datamonitor/monitor-agent/issues/1444
[#1446]: https://github.com/Datamonitor/monitor-agent/issues/1446
[#1447]: https://github.com/Datamonitor/monitor-agent/issues/1447
[#1454]: https://github.com/Datamonitor/monitor-agent/issues/1454
[#1457]: https://github.com/Datamonitor/monitor-agent/issues/1457
[#1459]: https://github.com/Datamonitor/monitor-agent/issues/1459
[#1461]: https://github.com/Datamonitor/monitor-agent/issues/1461
[#1476]: https://github.com/Datamonitor/monitor-agent/issues/1476
[#1482]: https://github.com/Datamonitor/monitor-agent/issues/1482
[#1487]: https://github.com/Datamonitor/monitor-agent/issues/1487
[#1490]: https://github.com/Datamonitor/monitor-agent/issues/1490
[#1503]: https://github.com/Datamonitor/monitor-agent/issues/1503
[#1507]: https://github.com/Datamonitor/monitor-agent/issues/1507
[#1509]: https://github.com/Datamonitor/monitor-agent/issues/1509
[#1511]: https://github.com/Datamonitor/monitor-agent/issues/1511
[#1512]: https://github.com/Datamonitor/monitor-agent/issues/1512
[#1518]: https://github.com/Datamonitor/monitor-agent/issues/1518
[#1527]: https://github.com/Datamonitor/monitor-agent/issues/1527
[#1535]: https://github.com/Datamonitor/monitor-agent/issues/1535
[#1549]: https://github.com/Datamonitor/monitor-agent/issues/1549
[#1550]: https://github.com/Datamonitor/monitor-agent/issues/1550
[#1558]: https://github.com/Datamonitor/monitor-agent/issues/1558
[#1559]: https://github.com/Datamonitor/monitor-agent/issues/1559
[#1561]: https://github.com/Datamonitor/monitor-agent/issues/1561
[#1565]: https://github.com/Datamonitor/monitor-agent/issues/1565
[#1569]: https://github.com/Datamonitor/monitor-agent/issues/1569
[#1570]: https://github.com/Datamonitor/monitor-agent/issues/1570
[#1577]: https://github.com/Datamonitor/monitor-agent/issues/1577
[#1579]: https://github.com/Datamonitor/monitor-agent/issues/1579
[#1582]: https://github.com/Datamonitor/monitor-agent/issues/1582
[#1586]: https://github.com/Datamonitor/monitor-agent/issues/1586
[#1589]: https://github.com/Datamonitor/monitor-agent/issues/1589
[#1590]: https://github.com/Datamonitor/monitor-agent/issues/1590
[#1592]: https://github.com/Datamonitor/monitor-agent/issues/1592
[#1594]: https://github.com/Datamonitor/monitor-agent/issues/1594
[#1595]: https://github.com/Datamonitor/monitor-agent/issues/1595
[#1596]: https://github.com/Datamonitor/monitor-agent/issues/1596
[#1611]: https://github.com/Datamonitor/monitor-agent/issues/1611
[#1612]: https://github.com/Datamonitor/monitor-agent/issues/1612
[#1613]: https://github.com/Datamonitor/monitor-agent/issues/1613
[#1614]: https://github.com/Datamonitor/monitor-agent/issues/1614
[#1616]: https://github.com/Datamonitor/monitor-agent/issues/1616
[#1617]: https://github.com/Datamonitor/monitor-agent/issues/1617
[#1618]: https://github.com/Datamonitor/monitor-agent/issues/1618
[#1619]: https://github.com/Datamonitor/monitor-agent/issues/1619
[#1620]: https://github.com/Datamonitor/monitor-agent/issues/1620
[#1621]: https://github.com/Datamonitor/monitor-agent/issues/1621
[#1623]: https://github.com/Datamonitor/monitor-agent/issues/1623
[#1626]: https://github.com/Datamonitor/monitor-agent/issues/1626
[#1628]: https://github.com/Datamonitor/monitor-agent/issues/1628
[#1630]: https://github.com/Datamonitor/monitor-agent/issues/1630
[#1631]: https://github.com/Datamonitor/monitor-agent/issues/1631
[#1633]: https://github.com/Datamonitor/monitor-agent/issues/1633
[#1640]: https://github.com/Datamonitor/monitor-agent/issues/1640
[#1642]: https://github.com/Datamonitor/monitor-agent/issues/1642
[#1643]: https://github.com/Datamonitor/monitor-agent/issues/1643
[#1644]: https://github.com/Datamonitor/monitor-agent/issues/1644
[#1645]: https://github.com/Datamonitor/monitor-agent/issues/1645
[#1650]: https://github.com/Datamonitor/monitor-agent/issues/1650
[#1651]: https://github.com/Datamonitor/monitor-agent/issues/1651
[#1655]: https://github.com/Datamonitor/monitor-agent/issues/1655
[#1657]: https://github.com/Datamonitor/monitor-agent/issues/1657
[#1660]: https://github.com/Datamonitor/monitor-agent/issues/1660
[#1664]: https://github.com/Datamonitor/monitor-agent/issues/1664
[#1666]: https://github.com/Datamonitor/monitor-agent/issues/1666
[#1679]: https://github.com/Datamonitor/monitor-agent/issues/1679
[#1691]: https://github.com/Datamonitor/monitor-agent/issues/1691
[#1696]: https://github.com/Datamonitor/monitor-agent/issues/1696
[#1700]: https://github.com/Datamonitor/monitor-agent/issues/1700
[#1701]: https://github.com/Datamonitor/monitor-agent/issues/1701
[#1709]: https://github.com/Datamonitor/monitor-agent/issues/1709
[#1710]: https://github.com/Datamonitor/monitor-agent/issues/1710
[#1715]: https://github.com/Datamonitor/monitor-agent/issues/1715
[#1717]: https://github.com/Datamonitor/monitor-agent/issues/1717
[#1718]: https://github.com/Datamonitor/monitor-agent/issues/1718
[#1720]: https://github.com/Datamonitor/monitor-agent/issues/1720
[#1721]: https://github.com/Datamonitor/monitor-agent/issues/1721
[#1722]: https://github.com/Datamonitor/monitor-agent/issues/1722
[#1725]: https://github.com/Datamonitor/monitor-agent/issues/1725
[#1726]: https://github.com/Datamonitor/monitor-agent/issues/1726
[#1727]: https://github.com/Datamonitor/monitor-agent/issues/1727
[#1734]: https://github.com/Datamonitor/monitor-agent/issues/1734
[#1736]: https://github.com/Datamonitor/monitor-agent/issues/1736
[#1737]: https://github.com/Datamonitor/monitor-agent/issues/1737
[#1744]: https://github.com/Datamonitor/monitor-agent/issues/1744
[#1745]: https://github.com/Datamonitor/monitor-agent/issues/1745
[#1747]: https://github.com/Datamonitor/monitor-agent/issues/1747
[#1750]: https://github.com/Datamonitor/monitor-agent/issues/1750
[#1752]: https://github.com/Datamonitor/monitor-agent/issues/1752
[#1755]: https://github.com/Datamonitor/monitor-agent/issues/1755
[#1757]: https://github.com/Datamonitor/monitor-agent/issues/1757
[#1758]: https://github.com/Datamonitor/monitor-agent/issues/1758
[#1759]: https://github.com/Datamonitor/monitor-agent/issues/1759
[#1760]: https://github.com/Datamonitor/monitor-agent/issues/1760
[#1761]: https://github.com/Datamonitor/monitor-agent/issues/1761
[#1767]: https://github.com/Datamonitor/monitor-agent/issues/1767
[#1770]: https://github.com/Datamonitor/monitor-agent/issues/1770
[#1771]: https://github.com/Datamonitor/monitor-agent/issues/1771
[#1772]: https://github.com/Datamonitor/monitor-agent/issues/1772
[#1773]: https://github.com/Datamonitor/monitor-agent/issues/1773
[#1774]: https://github.com/Datamonitor/monitor-agent/issues/1774
[#1776]: https://github.com/Datamonitor/monitor-agent/issues/1776
[#1777]: https://github.com/Datamonitor/monitor-agent/issues/1777
[#1782]: https://github.com/Datamonitor/monitor-agent/issues/1782
[#1785]: https://github.com/Datamonitor/monitor-agent/issues/1785
[#1786]: https://github.com/Datamonitor/monitor-agent/issues/1786
[#1789]: https://github.com/Datamonitor/monitor-agent/issues/1789
[#1792]: https://github.com/Datamonitor/monitor-agent/issues/1792
[#1793]: https://github.com/Datamonitor/monitor-agent/issues/1793
[#1798]: https://github.com/Datamonitor/monitor-agent/issues/1798
[#1799]: https://github.com/Datamonitor/monitor-agent/issues/1799
[#1800]: https://github.com/Datamonitor/monitor-agent/issues/1800
[#1811]: https://github.com/Datamonitor/monitor-agent/issues/1811
[#1813]: https://github.com/Datamonitor/monitor-agent/issues/1813
[#1820]: https://github.com/Datamonitor/monitor-agent/issues/1820
[#1822]: https://github.com/Datamonitor/monitor-agent/issues/1822
[#1823]: https://github.com/Datamonitor/monitor-agent/issues/1823
[#1824]: https://github.com/Datamonitor/monitor-agent/issues/1824
[#1826]: https://github.com/Datamonitor/monitor-agent/issues/1826
[#1831]: https://github.com/Datamonitor/monitor-agent/issues/1831
[#1839]: https://github.com/Datamonitor/monitor-agent/issues/1839
[#1843]: https://github.com/Datamonitor/monitor-agent/issues/1843
[#1844]: https://github.com/Datamonitor/monitor-agent/issues/1844
[#1845]: https://github.com/Datamonitor/monitor-agent/issues/1845
[#1846]: https://github.com/Datamonitor/monitor-agent/issues/1846
[#1848]: https://github.com/Datamonitor/monitor-agent/issues/1848
[#1852]: https://github.com/Datamonitor/monitor-agent/issues/1852
[#1855]: https://github.com/Datamonitor/monitor-agent/issues/1855
[#1856]: https://github.com/Datamonitor/monitor-agent/issues/1856
[#1859]: https://github.com/Datamonitor/monitor-agent/issues/1859
[#1860]: https://github.com/Datamonitor/monitor-agent/issues/1860
[#1864]: https://github.com/Datamonitor/monitor-agent/issues/1864
[#1865]: https://github.com/Datamonitor/monitor-agent/issues/1865
[#1875]: https://github.com/Datamonitor/monitor-agent/issues/1875
[#1878]: https://github.com/Datamonitor/monitor-agent/issues/1878
[#1880]: https://github.com/Datamonitor/monitor-agent/issues/1880
[#1883]: https://github.com/Datamonitor/monitor-agent/issues/1883
[#1885]: https://github.com/Datamonitor/monitor-agent/issues/1885
[#1888]: https://github.com/Datamonitor/monitor-agent/issues/1888
[#1889]: https://github.com/Datamonitor/monitor-agent/issues/1889
[#1891]: https://github.com/Datamonitor/monitor-agent/issues/1891
[#1892]: https://github.com/Datamonitor/monitor-agent/issues/1892
[#1895]: https://github.com/Datamonitor/monitor-agent/issues/1895
[#1900]: https://github.com/Datamonitor/monitor-agent/issues/1900
[#1902]: https://github.com/Datamonitor/monitor-agent/issues/1902
[#1907]: https://github.com/Datamonitor/monitor-agent/issues/1907
[#1908]: https://github.com/Datamonitor/monitor-agent/issues/1908
[#1910]: https://github.com/Datamonitor/monitor-agent/issues/1910
[#1912]: https://github.com/Datamonitor/monitor-agent/issues/1912
[#1914]: https://github.com/Datamonitor/monitor-agent/issues/1914
[#1915]: https://github.com/Datamonitor/monitor-agent/issues/1915
[#1919]: https://github.com/Datamonitor/monitor-agent/issues/1919
[#1923]: https://github.com/Datamonitor/monitor-agent/issues/1923
[#1924]: https://github.com/Datamonitor/monitor-agent/issues/1924
[#1928]: https://github.com/Datamonitor/monitor-agent/issues/1928
[#1932]: https://github.com/Datamonitor/monitor-agent/issues/1932
[#1933]: https://github.com/Datamonitor/monitor-agent/issues/1933
[#1936]: https://github.com/Datamonitor/monitor-agent/issues/1936
[#1939]: https://github.com/Datamonitor/monitor-agent/issues/1939
[#1940]: https://github.com/Datamonitor/monitor-agent/issues/1940
[#1942]: https://github.com/Datamonitor/monitor-agent/issues/1942
[#1943]: https://github.com/Datamonitor/monitor-agent/issues/1943
[#1944]: https://github.com/Datamonitor/monitor-agent/issues/1944
[#1948]: https://github.com/Datamonitor/monitor-agent/issues/1948
[#1951]: https://github.com/Datamonitor/monitor-agent/issues/1951
[#1952]: https://github.com/Datamonitor/monitor-agent/issues/1952
[#1959]: https://github.com/Datamonitor/monitor-agent/issues/1959
[#1961]: https://github.com/Datamonitor/monitor-agent/issues/1961
[#1965]: https://github.com/Datamonitor/monitor-agent/issues/1965
[#1974]: https://github.com/Datamonitor/monitor-agent/issues/1974
[#1975]: https://github.com/Datamonitor/monitor-agent/issues/1975
[#1976]: https://github.com/Datamonitor/monitor-agent/issues/1976
[#1978]: https://github.com/Datamonitor/monitor-agent/issues/1978
[#1979]: https://github.com/Datamonitor/monitor-agent/issues/1979
[#1984]: https://github.com/Datamonitor/monitor-agent/issues/1984
[#1985]: https://github.com/Datamonitor/monitor-agent/issues/1985
[#1986]: https://github.com/Datamonitor/monitor-agent/issues/1986
[#1987]: https://github.com/Datamonitor/monitor-agent/issues/1987
[#1988]: https://github.com/Datamonitor/monitor-agent/issues/1988
[#1990]: https://github.com/Datamonitor/monitor-agent/issues/1990
[#1993]: https://github.com/Datamonitor/monitor-agent/issues/1993
[#1995]: https://github.com/Datamonitor/monitor-agent/issues/1995
[#1996]: https://github.com/Datamonitor/monitor-agent/issues/1996
[#1997]: https://github.com/Datamonitor/monitor-agent/issues/1997
[#2000]: https://github.com/Datamonitor/monitor-agent/issues/2000
[#2005]: https://github.com/Datamonitor/monitor-agent/issues/2005
[#2009]: https://github.com/Datamonitor/monitor-agent/issues/2009
[#2010]: https://github.com/Datamonitor/monitor-agent/issues/2010
[#2011]: https://github.com/Datamonitor/monitor-agent/issues/2011
[#2015]: https://github.com/Datamonitor/monitor-agent/issues/2015
[#2022]: https://github.com/Datamonitor/monitor-agent/issues/2022
[#2026]: https://github.com/Datamonitor/monitor-agent/issues/2026
[#2029]: https://github.com/Datamonitor/monitor-agent/issues/2029
[#2031]: https://github.com/Datamonitor/monitor-agent/issues/2031
[#2034]: https://github.com/Datamonitor/monitor-agent/issues/2034
[#2035]: https://github.com/Datamonitor/monitor-agent/issues/2035
[#2038]: https://github.com/Datamonitor/monitor-agent/issues/2038
[#2039]: https://github.com/Datamonitor/monitor-agent/issues/2039
[#2040]: https://github.com/Datamonitor/monitor-agent/issues/2040
[#2048]: https://github.com/Datamonitor/monitor-agent/issues/2048
[#2055]: https://github.com/Datamonitor/monitor-agent/issues/2055
[#2056]: https://github.com/Datamonitor/monitor-agent/issues/2056
[#2057]: https://github.com/Datamonitor/monitor-agent/issues/2057
[#2061]: https://github.com/Datamonitor/monitor-agent/issues/2061
[#2062]: https://github.com/Datamonitor/monitor-agent/issues/2062
[#2063]: https://github.com/Datamonitor/monitor-agent/issues/2063
[#2064]: https://github.com/Datamonitor/monitor-agent/issues/2064
[#2065]: https://github.com/Datamonitor/monitor-agent/issues/2065
[#2071]: https://github.com/Datamonitor/monitor-agent/issues/2071
[#2072]: https://github.com/Datamonitor/monitor-agent/issues/2072
[#2075]: https://github.com/Datamonitor/monitor-agent/issues/2075
[#2079]: https://github.com/Datamonitor/monitor-agent/issues/2079
[#2081]: https://github.com/Datamonitor/monitor-agent/issues/2081
[#2082]: https://github.com/Datamonitor/monitor-agent/issues/2082
[#2084]: https://github.com/Datamonitor/monitor-agent/issues/2084
[#2086]: https://github.com/Datamonitor/monitor-agent/issues/2086
[#2087]: https://github.com/Datamonitor/monitor-agent/issues/2087
[#2088]: https://github.com/Datamonitor/monitor-agent/issues/2088
[#2091]: https://github.com/Datamonitor/monitor-agent/issues/2091
[#2092]: https://github.com/Datamonitor/monitor-agent/issues/2092
[#2094]: https://github.com/Datamonitor/monitor-agent/issues/2094
[#2097]: https://github.com/Datamonitor/monitor-agent/issues/2097
[#2098]: https://github.com/Datamonitor/monitor-agent/issues/2098
[#2100]: https://github.com/Datamonitor/monitor-agent/issues/2100
[#2106]: https://github.com/Datamonitor/monitor-agent/issues/2106
[#2109]: https://github.com/Datamonitor/monitor-agent/issues/2109
[#2111]: https://github.com/Datamonitor/monitor-agent/issues/2111
[#2112]: https://github.com/Datamonitor/monitor-agent/issues/2112
[#2114]: https://github.com/Datamonitor/monitor-agent/issues/2114
[#2115]: https://github.com/Datamonitor/monitor-agent/issues/2115
[#2116]: https://github.com/Datamonitor/monitor-agent/issues/2116
[#2120]: https://github.com/Datamonitor/monitor-agent/issues/2120
[#2121]: https://github.com/Datamonitor/monitor-agent/issues/2121
[#2126]: https://github.com/Datamonitor/monitor-agent/issues/2126
[#2128]: https://github.com/Datamonitor/monitor-agent/issues/2128
[#2130]: https://github.com/Datamonitor/monitor-agent/issues/2130
[#2133]: https://github.com/Datamonitor/monitor-agent/issues/2133
[#2134]: https://github.com/Datamonitor/monitor-agent/issues/2134
[#2135]: https://github.com/Datamonitor/monitor-agent/issues/2135
[#2136]: https://github.com/Datamonitor/monitor-agent/issues/2136
[#2139]: https://github.com/Datamonitor/monitor-agent/issues/2139
[#2140]: https://github.com/Datamonitor/monitor-agent/issues/2140
[#2142]: https://github.com/Datamonitor/monitor-agent/issues/2142
[#2143]: https://github.com/Datamonitor/monitor-agent/issues/2143
[#2145]: https://github.com/Datamonitor/monitor-agent/issues/2145
[#2146]: https://github.com/Datamonitor/monitor-agent/issues/2146
[#2147]: https://github.com/Datamonitor/monitor-agent/issues/2147
[#2148]: https://github.com/Datamonitor/monitor-agent/issues/2148
[#2152]: https://github.com/Datamonitor/monitor-agent/issues/2152
[#2153]: https://github.com/Datamonitor/monitor-agent/issues/2153
[#2155]: https://github.com/Datamonitor/monitor-agent/issues/2155
[#2156]: https://github.com/Datamonitor/monitor-agent/issues/2156
[#2157]: https://github.com/Datamonitor/monitor-agent/issues/2157
[#2160]: https://github.com/Datamonitor/monitor-agent/issues/2160
[#2161]: https://github.com/Datamonitor/monitor-agent/issues/2161
[#2162]: https://github.com/Datamonitor/monitor-agent/issues/2162
[#2163]: https://github.com/Datamonitor/monitor-agent/issues/2163
[#2164]: https://github.com/Datamonitor/monitor-agent/issues/2164
[#2165]: https://github.com/Datamonitor/monitor-agent/issues/2165
[#2166]: https://github.com/Datamonitor/monitor-agent/issues/2166
[#2169]: https://github.com/Datamonitor/monitor-agent/issues/2169
[#2171]: https://github.com/Datamonitor/monitor-agent/issues/2171
[#2175]: https://github.com/Datamonitor/monitor-agent/issues/2175
[#2176]: https://github.com/Datamonitor/monitor-agent/issues/2176
[#2177]: https://github.com/Datamonitor/monitor-agent/issues/2177
[#2179]: https://github.com/Datamonitor/monitor-agent/issues/2179
[#2180]: https://github.com/Datamonitor/monitor-agent/issues/2180
[#2181]: https://github.com/Datamonitor/monitor-agent/issues/2181
[#2182]: https://github.com/Datamonitor/monitor-agent/issues/2182
[#2183]: https://github.com/Datamonitor/monitor-agent/issues/2183
[#2184]: https://github.com/Datamonitor/monitor-agent/issues/2184
[#2185]: https://github.com/Datamonitor/monitor-agent/issues/2185
[#2189]: https://github.com/Datamonitor/monitor-agent/issues/2189
[#2192]: https://github.com/Datamonitor/monitor-agent/issues/2192
[#2193]: https://github.com/Datamonitor/monitor-agent/issues/2193
[#2198]: https://github.com/Datamonitor/monitor-agent/issues/2198
[#2199]: https://github.com/Datamonitor/monitor-agent/issues/2199
[#2200]: https://github.com/Datamonitor/monitor-agent/issues/2200
[#2201]: https://github.com/Datamonitor/monitor-agent/issues/2201
[#2202]: https://github.com/Datamonitor/monitor-agent/issues/2202
[#2203]: https://github.com/Datamonitor/monitor-agent/issues/2203
[#2205]: https://github.com/Datamonitor/monitor-agent/issues/2205
[#2206]: https://github.com/Datamonitor/monitor-agent/issues/2206
[#2207]: https://github.com/Datamonitor/monitor-agent/issues/2207
[#2208]: https://github.com/Datamonitor/monitor-agent/issues/2208
[#2210]: https://github.com/Datamonitor/monitor-agent/issues/2210
[#2215]: https://github.com/Datamonitor/monitor-agent/issues/2215
[#2216]: https://github.com/Datamonitor/monitor-agent/issues/2216
[#2220]: https://github.com/Datamonitor/monitor-agent/issues/2220
[#2223]: https://github.com/Datamonitor/monitor-agent/issues/2223
[#2225]: https://github.com/Datamonitor/monitor-agent/issues/2225
[#2227]: https://github.com/Datamonitor/monitor-agent/issues/2227
[#2228]: https://github.com/Datamonitor/monitor-agent/issues/2228
[#2229]: https://github.com/Datamonitor/monitor-agent/issues/2229
[#2234]: https://github.com/Datamonitor/monitor-agent/issues/2234
[#2235]: https://github.com/Datamonitor/monitor-agent/issues/2235
[#2236]: https://github.com/Datamonitor/monitor-agent/issues/2236
[#2242]: https://github.com/Datamonitor/monitor-agent/issues/2242
[#2244]: https://github.com/Datamonitor/monitor-agent/issues/2244
[#2246]: https://github.com/Datamonitor/monitor-agent/issues/2246
[#2248]: https://github.com/Datamonitor/monitor-agent/issues/2248
[#2249]: https://github.com/Datamonitor/monitor-agent/issues/2249
[#2250]: https://github.com/Datamonitor/monitor-agent/issues/2250
[#2260]: https://github.com/Datamonitor/monitor-agent/issues/2260
[#2264]: https://github.com/Datamonitor/monitor-agent/issues/2264
[#2268]: https://github.com/Datamonitor/monitor-agent/issues/2268
[#2271]: https://github.com/Datamonitor/monitor-agent/issues/2271
[#2274]: https://github.com/Datamonitor/monitor-agent/issues/2274
[#2278]: https://github.com/Datamonitor/monitor-agent/issues/2278
[#2280]: https://github.com/Datamonitor/monitor-agent/issues/2280
[#2283]: https://github.com/Datamonitor/monitor-agent/issues/2283
[#2285]: https://github.com/Datamonitor/monitor-agent/issues/2285
[#2287]: https://github.com/Datamonitor/monitor-agent/issues/2287
[#2288]: https://github.com/Datamonitor/monitor-agent/issues/2288
[#2289]: https://github.com/Datamonitor/monitor-agent/issues/2289
[#2291]: https://github.com/Datamonitor/monitor-agent/issues/2291
[#2292]: https://github.com/Datamonitor/monitor-agent/issues/2292
[#2296]: https://github.com/Datamonitor/monitor-agent/issues/2296
[#2299]: https://github.com/Datamonitor/monitor-agent/issues/2299
[#2304]: https://github.com/Datamonitor/monitor-agent/issues/2304
[#2308]: https://github.com/Datamonitor/monitor-agent/issues/2308
[#2309]: https://github.com/Datamonitor/monitor-agent/issues/2309
[#2314]: https://github.com/Datamonitor/monitor-agent/issues/2314
...
[@datamonitorhq]: https://github.com/datamonitorhq

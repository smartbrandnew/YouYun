...
if sys.platform == 'win32':
    ...
    class Target(object):
        def __init__(self, **kw):
            ...
            self.company_name = 'uyunsoft, Inc.'
            self.copyright = 'Copyright 2016 uyunsoft, Inc.'
            self.cmdline_style = 'pywin32'

    agent_svc = Target(name='Monitor Agent', modules='win32.agent', dest_base='monitoragent')
    ...
    extra_args = {
        ...
        'windows': [{'script': 'win32\gui.py',
                     ...
                     'icon_resources': [(1, r"packaging\datamonitor-agent\win32\install_files\monitor_agent_win_256.ico")],
                     }],
        'data_files': [
    ...
    plist.update(dict(
        CFBundleGetInfoString="{0}, Copyright (c) 2009-{1}, uyunsoft Inc.".format(
...
setup(
    ...
    author='uyunsoft',
    author_email='BD@uyun.cn',
    url='https://www.uyuntest.cn/uyun_monitor.shtml',

...
class AgentUpdater(object):
    ...
    def do_update(self):
        ...
        try:
            ...
            log.error("error on update agent, self.last_md5 has no key: {}".format(traceback.format_exc()))
        except IOError:
            log.error(traceback.format_exc())
        except Exception:
            log.error(traceback.format_exc())
    ...
    def store_md5_for_next_use(self):
        try:
            ...
            log.error("error on store md5. {}".format(traceback.format_exc()))
    ...
    def remove_extra_file(self):
        try:
            ...
            log.error("remove extra file error, {}".format(traceback.format_exc()))

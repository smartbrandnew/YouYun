...
Set colItems = wbemServices.ExecQuery("select Name, BytesReceivedPersec, BytesReceivedTotal, MessageBytesReceivedPersec, MessageBytesReceivedTotal, MessagesReceivedPersec, MessagesReceivedTotal  from  Win32_PerfFormattedData_MSExchangeTransportSMTPReceive_MSExchangeTransportSMTPReceive")
...
For Each row in colItems
	WScript.Echo row.Name _
		& "|" & row.BytesReceivedPersec _
		& "|" & row.BytesReceivedTotal _
		& "|" & row.MessageBytesReceivedPersec _
		& "|" & row.MessageBytesReceivedTotal _
		& "|" & row.MessagesReceivedPersec _
		& "|" & row.MessagesReceivedTotal
Next

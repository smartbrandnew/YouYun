...
import com.broada.carrier.monitor.impl.virtual.vmware.vcenter.vm.cluster.VCenterVmClusterMonitor;
...
public class VmwareMonitorPackage implements MonitorPackage {
	...
	public MonitorType[] getTypes() {
		...
		return new MonitorType[] {
				...
				new MonitorType("VMWARE", "VMWARE-VM-CLUSTER", "vCenter VM CLUSTER监测", "使用web service sdk监测集群的内存和存储使用情况。",
						MultiInstanceConfiger.class.getName(), VCenterVmClusterMonitor.class.getName(), index++,
						targetTypeIds, methodTypeIds),

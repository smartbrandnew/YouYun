package com.broada.carrier.monitor.impl.storage.dell.equallogic.controller.chipTemp.bean;
...
//	private Double contrPhysRam;
	...
	//预阀值(芯片温度(℃))
	Double checkChipsetTemp = new Double(60);
	// GET SET
...
//	}
	...
	public Double getCheckChipsetTemp() {
		return checkChipsetTemp;
	}

	public void setCheckChipsetTemp(Double checkChipsetTemp) {
		this.checkChipsetTemp = checkChipsetTemp;
	}

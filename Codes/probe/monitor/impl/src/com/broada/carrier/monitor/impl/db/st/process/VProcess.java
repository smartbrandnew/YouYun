...
public class VProcess implements Serializable{
  ...
  public String getUsedMemText() {
    return convert2MText(usedMem);
  }

  public void addUsedMem(long usedMem) {
    this.usedMem += usedMem;
  }
  ...
  public String getAllocMemText() {
    return convert2MText(allocMem);
  }

  public void addAllocMem(long allocMem) {
  ...
  public void copyTo(VProcess target) {
    ...
    target.allocMem = this.allocMem;
    target.usedMem = this.usedMem;

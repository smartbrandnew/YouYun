...
public interface CLIConstant {
	...
	public final static String OPTIONS_PASSD = "password";
	...
	public final static String OPTIONS_PASSDPROMPT = "passwdPrompt";
	...
	public final static String LOCALHOST = HostIpUtil.getLocalHost();

...
public class Config extends BaseConfig {
	...
	private static String getGatewayIp() {
		...
		try {
			...
			while (line != null) {
				line = line.trim();
				if (line.startsWith("default") || line.startsWith(HostIpUtil.getZeroIP()) == true) {
					break;
				}
	...
	public String getServerIp() {
		return getProps().get("server.ipaddr", HostIpUtil.getLocalHost());
	}
	...
	public String getProbeIp() {
		return getProps().get("probe.ipaddr", HostIpUtil.getLocalHost());
	}

	public String getProbeCode() {
		return getProps().get("probe.code", HostIpUtil.getLocalHost());
	}

	public String getProbeHostName() {
		return getProps().get("probe.hostname", HostIpUtil.getLocalHost());
	}

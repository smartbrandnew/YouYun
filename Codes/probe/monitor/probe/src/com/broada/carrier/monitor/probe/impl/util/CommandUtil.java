...
import com.broada.carrier.monitor.impl.host.ipmi.sdk.core.common.ConfigProperties;
...
public class CommandUtil {
	...
	public static String[] exec(String command, int timeout, String defaultPath, boolean isTest) throws IPMIException {
	...
	private static String getAbsolutePath(String defaultValue) {
		...
		if (absolutePath == null)
			if(OsInfoUtil.getOS().equalsIgnoreCase("windows"))
				absolutePath = file.getPath() + "/conf/ipmitool/";
			else
				absolutePath = file.getPath() + "/conf/ipmitool-linux/src/";
		return absolutePath;			
	}

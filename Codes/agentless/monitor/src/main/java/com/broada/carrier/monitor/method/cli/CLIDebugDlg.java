...
public class CLIDebugDlg extends JDialog {
  ...
  private void jbInit() throws Exception {
    ...
    jButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (JFileChooser.APPROVE_OPTION == chooser.showSaveDialog(CLIDebugDlg.this)) {
          ...
          try {
            ...
            ErrorDlg.createErrorDlg(CLIDebugDlg.this, "错误", ex.getMessage(), ex).setVisible(true);
          }
        }
      }
    });
  ...
  public void addHostInfo(Properties options) {
    ...
    addContent(MessageFormat.format(HOST_INFO, new Object[] { options.getProperty(CLIConstant.OPTIONS_REMOTEHOST),
        options.getProperty(CLIConstant.OPTIONS_OS), options.getProperty(CLIConstant.OPTIONS_OSVERSION),
        port == null ? "" : port.toString(), options.getProperty(CLIConstant.OPTIONS_SESSIONNAME),
        options.getProperty(CLIConstant.OPTIONS_LOGINNAME), options.getProperty(CLIConstant.OPTIONS_LOGINPROMPT),
        options.getProperty(CLIConstant.OPTIONS_PASSWORDPROMPT), options.getProperty(CLIConstant.OPTIONS_PROMPT),
  ...
  public void addContent(String text) {
    ...
    javax.swing.SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        jEditorPane.setText(MessageFormat.format(HTML, new Object[] { getTitle(), oldContent }));
      }
    });
  }
  ...
  public void addError(String message, Throwable t){
    ...
    addContent(MessageFormat.format(ERROR, new Object[]{XmlEscapeUtil.escapeXml(message),XmlEscapeUtil.escapeXml(stringWriter.getBuffer().toString())}));
  }
  ...
  private JEditorPane jEditorPane = new JEditorPane("text/html", "正在等待执行命令返回,请等待...");

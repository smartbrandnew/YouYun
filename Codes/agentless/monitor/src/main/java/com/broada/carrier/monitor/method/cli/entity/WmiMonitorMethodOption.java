...
public class WmiMonitorMethodOption extends MonitorMethod {
	...
	private final static String OPTIONS_PASSWORD = "password";
	...
	public String getPassword() {
		return getProperties().get(OPTIONS_PASSWORD, "");
	}

	public void setPassword(String password) {
		getProperties().set(OPTIONS_PASSWORD, password);
	}
	...
	public Properties toOptions(String ipAddr) {
		...
		properties.put(CLIConstant.OPTIONS_PASSWORD, getPassword());

...
public class PingUtil {
	 ...
	 * @return
	 */
	private static int getCheckResultV4(String line) { // System.out.println("控制台输出的结果为:"+line); 
	 ...
	 * @return
	 */
	private static int getCheckResultV6(String line) { // System.out.println("控制台输出的结果为:"+line);  

...
public class SnmpTuxManager {
	...
	public static void main(String args[]) throws Exception {
		SnmpWalk walk = new SnmpWalk(SnmpUtil.getVersion("v1"), "192.168.0.102", 161, "public");

		SnmpTuxManager stm = new SnmpTuxManager(walk);
		System.out.println(stm.getNumTran());
		System.out.println(stm.getNumTranCmt());
		System.out.println(stm.getWkCompleted());
		System.out.println(stm.getWkIntiated());
		System.out.println(stm.getCurClients());
		System.out.println(stm.getWsCurClients());
		InstanceItem[] ii = stm.getPmid();
		System.out.println(stm.getState(ii[0]));
		walk.close();
	}

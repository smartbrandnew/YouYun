...
public class IbmMqManager {
  ...
  public static void doGet() {
  	IbmMqManager m = new IbmMqManager(new Parameter("1.1.1.4", 1417, 1208));
    List list = null;
    try {
      m.initQmgr();
      list = m.getAllQueues();
      ...
      for (int i = 0; i < list.size(); i++) {
        ...
        System.out.println("channelName:" + chan.getCName());
        System.out.println("rvdBytes:" + chan.getReceiveByte());
        System.out.println("state:" + chan.getCState() + "，对应的中文状态："
            + IbmMqChannelState.getMQChState(chan.getCState().intValue()));
        System.out.println("sendBytes:" + chan.getSendByte());
        System.out.println("msgCount:" + chan.getAffairNum());
        System.out.println("lastMsgTime:" + chan.getLastMsgTime());
        System.out.println("ctype:" + chan.getCType() + "，对应的中文状态："
      ...
      for (int i = 0; i < list.size(); i++) {
      	...
      	System.out.println(queue.getQName());
      }

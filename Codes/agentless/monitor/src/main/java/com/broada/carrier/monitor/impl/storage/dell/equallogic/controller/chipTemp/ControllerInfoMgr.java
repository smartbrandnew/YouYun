...
//					.toLong());
			controllerInfo.setChipsetTemp((double) results[4].getValue()
					.toLong());
...
//			controllerInfo.setCheckChipsetTemp(checkChipsetTemp)

...
class Listen(Command):
    """\
        ...
        At any moment you can subscribe to a circle event. Circus provides
        a PUB/SUB feed on which any clients can subscribe. The subscriber
        endpoint URI is set in the circle.ini configuration file.
        ...
        ::
            ...
            $ circlectl listen tcp://127.0.0.1:5556

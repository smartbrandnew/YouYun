...
from circle.commands.util import validate_option
from circle.config import rlimit_value
...
class AddWatcher(Command):
    ...
    def execute(self, arbiter, props):
        ...
        watcher = arbiter.add_watcher(
            props['name'], props['cmd'], args=props.get('args'), **options)

...
from circle.util import TransformableFuture
...
class Reload(Command):
    """\
        ...
        * Otherwise:
        ...
        ::
            ...
            $ circlectl reload [<name>] [--terminate] [--waiting]
                                        [--sequential]
    ...
    def message(self, *args, **opts):
        ...
        if len(args) == 1:
            ...
            return self.make_message(
                graceful=graceful, waiting=waiting, sequential=sequential)
    ...
    def execute(self, arbiter, props):
        ...
        if 'name' in props:
            ...
            if props.get('waiting'):
                ...
                resp.set_upstream_future(
                    watcher.reload(
                        graceful=graceful, sequential=sequential))
                resp.set_transform_function(lambda x: {"info": x})
                return resp
            return watcher.reload(graceful=graceful, sequential=sequential)
        else:

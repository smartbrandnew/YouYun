...
from circle.util import to_string
from circle.util import (get_info, to_uid, to_gid, debuglog, get_working_dir,
...
# todo, change into not support 2.x
# psutil < 2.x compat
    ...
    def format_args(self):
        ...
        if self.shell:
            ...
            logger.warn("shell_args is defined but won't be used "
                        "in this context: {}"
                        .format(format_kwargs['shell_args']))

...
class ActiveMQXML(AgentCheck):
    SERVICE_CHECK_NAME = 'activemq.can_connect'
    ...
    def check(self, instance):
        ...
        self.log.debug('Check ActiveMQ Connect %s' % url)
        self.check_connect(url, '/admin', username, password)
    ...
    def check_connect(self, base_url, xml_url=None, username=None, password=None):

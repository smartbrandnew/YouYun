...
class Mesos(AgentCheck):
    ...
    def check(self, instance):
        self.warning("This check is deprecated in favor of Mesos master and slave specific checks."
                     " It will be removed in a future version of the Monitor Agent.")
        ...
        if response is not None:
            tags = instance_tags
            for attr in ['deactivated_slaves', 'failed_tasks', 'finished_tasks', 'killed_tasks', 'lost_tasks',
                         'staged_tasks', 'started_tasks']:
